...
> 由 Ship 文档流程生成。当前项目保留扁平 `docs/` 结构，未纳入管理的旧文档不在此索引中。
...
| design | 007 | current | 007 - TgBuddy 代码仓库设计 | TgBuddy Agent Runtime 的组件、端口、调用流、依赖方向与宿主装配边界。 | 2026-07-31 | [007](07-代码仓库设计.md) |
